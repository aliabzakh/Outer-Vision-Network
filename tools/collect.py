#!/usr/bin/env python3
"""Collect real training crops for the shape net. The label comes from the SESSION, not from a model:
put only objects of ONE shape on the table, run with --label <shape>, and move your head around.
  ...
  .venv-train/bin/python tools/train_shape.py --real data/real
